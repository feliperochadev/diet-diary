...
class MealLoader implements ApplicationListener<ContextRefreshedEvent>  {
    ...
    void onApplicationEvent(ContextRefreshedEvent event){
        ...
        def meal = new Meal(date: date - 2, meal: MealType.BREAKFAST,
        ...
        def meal2 = new Meal(date: date - 2, meal: MealType.LUNCH,
        ...
        def meal3 = new Meal(date: date - 2, meal: MealType.DINNER,
                foods: [new Food(name: "O ORGANICS, QUICK-COOK RICE BLEND, ORGANIC BROWN BASMATI RICE, ORGANIC WHOLE GRAIN RED RICE, UPC: 079893502274", calories: 350, ndbno: "45091352"),
        ...
        def meal4 = new Meal(date: date - 1, meal: MealType.LUNCH,
        ...
        def meal5 = new Meal(date: date - 1, meal: MealType.SNACK,
